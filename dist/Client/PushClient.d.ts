...
import tls from 'tls';
import { DsoMessage, PushTlv, RetryDelayTlv } from '../Lib/Dso.js';
...
export declare class PushClient extends EventEmitter {
    ...
    reconfirm(name: string, qtype: PacketTypes | number, qclass: PacketClass | number, rdata: Buffer): Promise<void>;
    close(): Promise<void>;
    ...
    protected _doReconnect(): Promise<void>;
