...
export type {
    ...
    TcpConnectionPoolProtocol,
    TcpConnectionPoolTarget,
    TcpConnectionPoolTransportDefaults
} from './Client/TcpConnectionPool.js';
...
export type {
    ...
    ManagedKey,
    RolloverEvent,
    TrustAnchorManagerOptions,
    SerializedTrustAnchorState
} from './Resolver/TrustAnchorManager.js';
